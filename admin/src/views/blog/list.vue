  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.type" placeholder="Tag" clearable class="filter-item" style="width: 200px">
        <el-option v-for="item in tagList" :key="item.key" :label="item.display_name+'('+item.key+')'" :value="item.key" />
      </el-select>
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="Type" prop="type">
          <el-select v-model="temp.type" class="filter-item" placeholder="Please select">
            <el-option v-for="item in tagList" :key="item.key" :label="item.display_name" :value="item.key" />
          </el-select>
        </el-form-item>
...
const calendarTypeKeyValue = tagList.reduce((acc, cur) => {
